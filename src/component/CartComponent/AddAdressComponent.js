    ...
    <View>
      ...
      <View style={styles.modelView}>
        ...
        <View style={styles.contentView}>
          <FormControl
            isRequired
            isInvalid={submited && city == "" ? true : false}
          >
            <Input
              variant="outline"
              value={name}
          ...
          <FormControl
            isRequired
            isInvalid={submited && country == "" ? true : false}
          >
            <Select
          ...
          <FormControl
            isRequired
            isInvalid={submited && postcode == "" ? true : false}
          >
            <Input
              variant="outline"
              value={postcode}
          ...
          <FormControl
            isRequired
            isInvalid={submited && address1 == "" ? true : false}
          >
            <TextArea
              value={address1}
              variant="outline"
              ...
              onChangeText={(value) =>
                setState({ ...state, address1: value, submited: false })
              }
            />
            <FormControl.ErrorMessage leftIcon={<InfoOutlineIcon size="xs" />}>
              Address is required
