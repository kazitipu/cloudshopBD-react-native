...
function ProductDetailScreen(props) {
    const [state, setState] = React.useState({ loading: true, productCount: 1, productDetail: null, fetchCart: false, selectedColor: 1, showZoom: false, zoomImages: [], msg: '' });
    const { loading, productDetail, selectedColor, productCount, zoomImages, showZoom, msg } = state;
                ...
                loading ? <OtrixLoader /> : <>
                    ...
                    <OtrixContent customStyles={styles.productDetailView}>
                        ...
                        <ScrollView style={styles.childView} showsVerticalScrollIndicator={false}>
                            ...
                            <View style={styles.subContainer}>
                                ...
                                <View style={styles.starView}>
                                    <Stars
                                        ...
                                        disabled={true}
                                    />
                                    <Text style={styles.reviewTxt}>({productDetail.reviewCount} Reviews)</Text>
                                </View>
                            </View>
                            <OtrixDivider size={'lg'} />
                            ...
                            <Text style={[styles.headingTxt, { fontSize: wp('3.8%') }]}>Description</Text>
